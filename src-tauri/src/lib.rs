...
pub fn run(cli_args: CliArgs) {
    ...
    let specta_builder = Builder::<tauri::Wry>::new()
        .commands(collect_commands![
            ...
            shortcut::change_user_full_name_setting,
            shortcut::change_formality_treatment_setting,
            shortcut::set_formalize_prompt,
            shortcut::update_custom_words,
            shortcut::update_custom_replacements,
            ...
            commands::models::complete_onboarding,
            ...
            commands::history::get_activity_map,
